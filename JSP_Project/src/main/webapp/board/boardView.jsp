...
<body>
	...
	<table border=1>
		...
		<tr>
			<td colspan="4"><input type="button" value="글수정폼"
				onclick="location.href ='updateForm.jsp?num=<%=num%>'" /> 
				<input type="button" value="삭제" onclick="del()" /> <input type="button"
				value="답글쓰기"
	...
	<div align="center">
		...
		<input type="button" value="commentInsert" id="commentBtn" />
	</div>
	<br /> Comment(<span id = "cntSpan"></span>)
	<br />
	<div id="result"></div>
	<script>
		var init = function() {
